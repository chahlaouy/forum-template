...
<div class="max-w-7xl mx-auto h-56 flex items-end">
    ...
    <div class="flex-1">
        ...
        <div class="flex items-center">
            <button class="focus:outline-none block px-14 text-center text-gray-100 py-2 bg-blue-600 rounded-full shadow mr-3">
                follow
            </button>
            ...
            <span class="block px-4 text-center py-2">
                a propos
            </span>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto flex">
        <div class="w-96 p-8 -mt-48">
            <div class="w-full h-96 relative">
                <div class="absolute w-full h-full z-20 bg-gray-900 bg-opacity-50 rounded-t-2xl">
                ...
                <div class="absolute bottom-0 right-0 p-4 w-full flex z-30 items-center justify-between">
                    <button class="focus:outline-none block px-5 text-center text-gray-700 py-2 bg-green-300 rounded-full shadow mr-3 font-semibold">
            ...
            @forelse ($userProfile->threads as $thread)
                ...
                <div class="w-full bg-white rounded-2xl shadow flex justify-between my-8">
                    <div class="p-4 flex-1">
                        <a href="{{$thread->channel->path()}}" class="uppercase text-green-400"> {{$thread->channel->name}} </a>
                        <a href="{{$thread->path()}}" class="block text-xl font-bold tracking-wide hover:text-blue-600 pb-4">{{$thread->title}}</a>
                        <p class="tracking-wider leading-loose text-gray-600 text-xs pb-4">
